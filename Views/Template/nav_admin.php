            ...
            <?php if (!empty($_SESSION['permisos'][2]['r'])) { ?>
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a class="treeview-item" href="<?= base_url(); ?>/registro"><i class="icon fa fa-circle-o"></i> Registro Actividad</a></li>
                    </ul>
                </li>
            <?php } ?>
            ...
            <?php if (!empty($_SESSION['permisos'][5]['r'])) { ?>
                <li>
                    <a class="app-menu__item" href="<?= base_url(); ?>/clinica">
                        <i class="app-menu__icon fa fa-hospital" aria-hidden="true"></i>
                        <span class="app-menu__label">Clinica</span>
                    </a>
                </li>
            <?php } ?>
