		...
		<tbody>
			...
			<tr>
				<td>
					...
					<p>Bienvenido a nuestra Veterinaria el Mister.</p>
					<p>Ahora puedes realizar todas las consultas de tu mascota</p>
					...
					<a href="<?= BASE_URL; ?>" target="_blank" class="x_button_link x_link_blue">Consulta ahora</a>
