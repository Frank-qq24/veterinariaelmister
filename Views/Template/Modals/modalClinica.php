<!-- Modal -->
<div class="modal fade" id="modalClinica" name="modalclinica" tabindex="-1" role="dialog" aria-hidden="true" >
      ...
      <div class="row">
        <div class="col-md-12">
            <section class="invoice">
              <div class="row mb-4">
                <div class="col-6">
                  <h2 class="page-header"><i class="fa fa-globe"></i> Veterinaria el Mister</h2>
                </div>
                <div class="col-6">
